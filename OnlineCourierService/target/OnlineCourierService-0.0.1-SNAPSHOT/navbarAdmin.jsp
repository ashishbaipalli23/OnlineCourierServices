<%@page import="com.ashi.BeansandDAOs.AdminBean"%>
...
<%
  ...
  if (admin == null) {
	session.setAttribute("msg", "session Expried login again..");
  ...
  <div class="container">
    ...
    <div class="d-flex ms-auto align-items-center">
      <span class="text-light me-3 fs-5">
        <i class="bi bi-person-circle me-1"></i>Welcome,<%= admin.getUsername() %>!
      </span>
      <a href="logoutAdmin.jsp" class="btn btn-outline-light btn-lg" onclick="return confirm('are you sure want to logout ?')">
